...
% Solve Laplace equation, reshape to 2D, and plot:
  ...
  [xx,yy] = meshgrid(x,y);xx=xx(end:-1:1,end:-1:1);yy=yy(end:-1:1,end:-1:1);
  [xxx,yyy] = meshgrid(-1:1/32:1,-1:1/32:1);
uuu = interp2(xx,yy,uu(end:-1:1,end:-1:1),xxx,yyy,'cubic');
  %clf, subplot('position',[.1 .4 .8 .5])
  surf(xxx,yyy,uuu)%, colormap(1e-6*[1 1 1]);
